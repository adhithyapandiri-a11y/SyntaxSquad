    ...
    <div className="space-y-6 max-w-4xl">
      ...
      {savedSuccess && (
        <div className="p-4 rounded-xl bg-white border border-[rgba(0,0,0,0.06)] text-[#0A0A0A] flex items-center gap-2 text-xs font-bold animate-in fade-in shadow-[0_2px_8px_rgba(0,0,0,0.02)] font-sans">
          <CheckCircle2 className="w-5 h-5 text-[#0A0A0A]" strokeWidth={1.5} /> Settings updated successfully!
        </div>
      )}
      ...
      <Card className="bg-white border border-[rgba(0,0,0,0.06)] rounded-2xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.02)] font-sans">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-base text-[#0A0A0A] tracking-[-0.05em]">
            <User className="w-5 h-5 text-[#0A0A0A]" strokeWidth={1.5} /> Account Profile
          </CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSave} className="space-y-4">
            <div className="flex items-center gap-4 pb-4 border-b border-[rgba(0,0,0,0.06)]">
              ...
              <div>
                ...
                <p className="text-[11px] text-[#757575] mt-1">Role: <span className="font-bold text-[#0A0A0A] capitalize">{activeRole}</span></p>
              </div>
            </div>
      ...
      <Card className="bg-white border border-[rgba(0,0,0,0.06)] rounded-2xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.02)] font-sans">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-base text-[#0A0A0A] tracking-[-0.05em]">
            {theme === 'dark' ? <Moon className="w-5 h-5 text-[#0A0A0A]" strokeWidth={1.5} /> : <Sun className="w-5 h-5 text-[#0A0A0A]" strokeWidth={1.5} />}
        ...
        <CardContent className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-[#757575]">Currently active theme: <span className="font-semibold capitalize">{theme}</span></p>
          </div>
