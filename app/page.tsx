...
export default function LandingPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Dynamic 7-day meal menu schedules, student rating feedback, calorie count transparency, and daily meal attendance counters.'
    },
    {
      icon: ShieldCheck,
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans selection:bg-blue-500 selection:text-white">
      ...
      <section className="relative pt-20 pb-24 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-500/10 via-indigo-500/5 to-transparent pointer-events-none" />
